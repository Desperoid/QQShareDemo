...
- (void)shareImageMessage
{
   ...
   [[QQShareManager shareInstance] shareToQQWithImageData:imageData preivewImageData:imageData title:@"vulcan" description:@"阿斯顿·马丁Vulcan充满赛车气息的车身里大量参考了传奇车型ONE-77的图纸，尽管官方并没有明确写出Vulcan与ONE-77的关系，但实际上Vulcan就可以被看作为终极版的ONE-77，采用碳纤维车身、前中置后驱布局、推杆式悬挂系统、后轮345/30 R19规格的米其林竞赛轮胎、7.0升V12自然吸气发动机(最大功率超过800马力)、6速序列式变速器。"];
}
...
- (void)shareImagesToFavorite
{
   NSURL *imageURL = [[NSBundle mainBundle] URLForResource:@"vulcan" withExtension:@"png"];
   NSData *imageData  = [NSData dataWithContentsOfURL:imageURL];
   NSData *imageData1 = [NSData dataWithContentsOfURL:[[NSBundle mainBundle] URLForResource:@"vulcan-1" withExtension:@"png"]];
   NSData *imageData2 = [NSData dataWithContentsOfURL:[[NSBundle mainBundle] URLForResource:@"vulcan-2" withExtension:@"png"]];
...
{
   NSURL *imageURL = [[NSBundle mainBundle] URLForResource:@"vulcan" withExtension:@"png"];
   [[QQShareManager shareInstance] shareURL:[NSURL URLWithString:@"http://www.autohome.com.cn/3730/6797/"] previewImageURL:imageURL title:@"vulcan" description:@"阿斯顿·马丁Vulcan" toQQPlatform:QQPlatformQQ];
}

- (void)shareURLToQZone
{
   NSURL *imageURL = [[NSBundle mainBundle] URLForResource:@"vulcan" withExtension:@"png"];
   [[QQShareManager shareInstance] shareURL:[NSURL URLWithString:@"http://www.autohome.com.cn/3730/6797/"] previewImageURL:imageURL title:@"vulcan" description:@"阿斯顿·马丁Vulcan" toQQPlatform:QQPlatformQZone];
}
...
- (void)shareMusic
{
   ...
   [[QQShareManager shareInstance] shareMusicURL:MusicURL preivewImageURL:imageURL flashURL:flashURL title:@"なんでもないや" description:@"你的名字" toQQPlatform:QQPlatformQZone];
}
